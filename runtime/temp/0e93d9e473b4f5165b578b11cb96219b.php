<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"../admin_themes/slide_category\edit.html";i:1483610894;s:25:"../admin_themes/base.html";i:1483610894;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class=""><a href="<?php echo url('admin/slide_category/index'); ?>">轮播分类</a></li>
            <li class=""><a href="<?php echo url('admin/slide_category/add'); ?>">添加分类</a></li>
            <li class="layui-this">编辑分类</li>
        </ul>
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form class="layui-form form-container" action="<?php echo url('admin/slide_category/update'); ?>" method="post">
                    <div class="layui-form-item">
                        <label class="layui-form-label">分类名称</label>
                        <div class="layui-input-block">
                            <input type="text" name="name" value="<?php echo $slide_category['name']; ?>" required  lay-verify="required" placeholder="请输入分类名称" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
